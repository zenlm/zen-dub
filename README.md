...
> **Attribution.** Zen-Dub is built on [MuseTalk](https://github.com/TMElyralab/MuseTalk) (MIT License, (c) 2024 Tencent Music Entertainment Lyra Lab). It also uses [sd-vae-ft-mse](https://huggingface.co/stabilityai/sd-vae-ft-mse) (Stability AI, MIT), [Whisper](https://github.com/openai/whisper) (OpenAI, MIT), and [face-alignment / 2D-FAN-4](https://github.com/1adrianb/face-alignment) (BSD-3) for the blend mask. The lip-sync UNet derives from Stable Diffusion v1.4 (CreativeML Open RAIL-M). See `NOTICE` and `THIRD-PARTY-LICENSES.md`. Zen-Dub itself is released under Apache-2.0 by the Zen Authors (https://zenlm.org).

We introduce `Zen-Dub`, a **real-time high quality** lip-syncing model (30fps+ on an NVIDIA Tesla V100). Zen-Dub can be applied with input videos, e.g., generated by [MuseV](https://github.com/hanzoai/MuseV), as a complete virtual human solution.

## 🔥 Updates
We're excited to unveil Zen-Dub 1.5.
...
**The inference codes, training codes and model weights of Zen-Dub 1.5 are all available now!** 🚀

# Overview
`Zen-Dub` is a real-time high quality audio-driven lip-syncing model trained in the latent space of `ft-mse-vae`, which
...
# News
- [04/05/2025] :mega: We are excited to announce that the training code is now open-sourced! You can now train your own Zen-Dub model using our provided training scripts and configurations.
...
- [04/17/2024] We release a pipeline that utilizes Zen-Dub for real-time inference.
- [04/16/2024] Release Gradio [demo](https://huggingface.co/spaces/hanzoai/Zen-Dub) on HuggingFace Spaces (thanks to HF team for their community grant)
- [04/02/2024] Release Zen-Dub project and pretrained models.


## Model
![Model Structure](https://github.com/user-attachments/assets/02f4a214-1bdd-4326-983c-e70b478accba)
Zen-Dub was trained in latent spaces, where the images were encoded by a freezed VAE. The audio was encoded by a freezed `whisper-tiny` model. The architecture of the generation network was borrowed from the UNet of the `stable-diffusion-v1-4`, where the audio embeddings were fused to the image embeddings by cross-attention.

Note that although we use a very similar architecture as Stable Diffusion, Zen-Dub is distinct in that it is **NOT** a diffusion model. Instead, Zen-Dub operates by inpainting in the latent space with a single step.
...
### Input Video
---
https://github.com/hanzoai/Zen-Dub/assets/163980830/37a3a666-7b90-4244-8d3a-058cb0e44107
...
- [x] Huggingface Gradio [demo](https://huggingface.co/spaces/hanzoai/Zen-Dub).
...
# Getting Started
We provide a detailed tutorial about the installation and the basic usage of Zen-Dub for new users:
...
### [ComfyUI](https://github.com/chaojie/ComfyUI-Zen-Dub)
...
```shell
conda create -n Zen-Dub python==3.10
conda activate Zen-Dub
```
...
# Example:
export FFMPEG_PATH=/zen-dub/ffmpeg-4.4-amd64-static
```
...
1. Download our trained [weights](https://huggingface.co/hanzoai/Zen-Dub/tree/main)
2. Download the weights of other components:
   - [sd-vae-ft-mse](https://huggingface.co/stabilityai/sd-vae-ft-mse/tree/main)
   - [whisper](https://huggingface.co/openai/whisper-tiny/tree/main)
   - [dwpose](https://huggingface.co/yzd-v/DWPose/tree/main)
   - [syncnet](https://huggingface.co/ByteDance/LatentSync/tree/main)
   - [2D-FAN-4 facial landmarks](https://www.adrianbulat.com/downloads/python-fan/2DFAN4-cd938726ad.zip) (from [face-alignment](https://github.com/1adrianb/face-alignment), BSD-3)
...
### Inference
We provide inference scripts for both versions of Zen-Dub:
...
```bash
# Zen-Dub 1.5 (Recommended)
python -m scripts.inference --inference_config configs\inference\test.yaml --result_dir results\test --unet_model_path models\zen-dubV15\unet.pth --unet_config models\zen-dubV15\zen-dub.json --version v15 --ffmpeg_path ffmpeg-master-latest-win64-gpl-shared\bin

# For Zen-Dub 1.0, change:
# - models\zen-dubV15 -> models\zen-dub
...
```bash
# Zen-Dub 1.5 (Recommended)
python -m scripts.realtime_inference --inference_config configs\inference\realtime.yaml --result_dir results\realtime --unet_model_path models\zen-dubV15\unet.pth --unet_config models\zen-dubV15\zen-dub.json --version v15 --fps 25 --ffmpeg_path ffmpeg-master-latest-win64-gpl-shared\bin
...
### Data Preparation
To train Zen-Dub, you need to prepare your dataset following these steps:
...
<table class="center">
  ...
  <tr>
    ...
    <td >
      <video src=https://github.com/hanzoai/Zen-Dub/assets/163980830/4a4bb2d1-9d14-4ca9-85c8-7f19c39f712e controls preload></video>
    </td>
    <td >
      <video src=https://github.com/hanzoai/Zen-Dub/assets/163980830/b2a879c2-e23a-4d39-911d-51f0343218e4 controls preload></video>
    </td>
  </tr>
  <tr>
    <td>
    ...
    <td >
      <video src=https://github.com/hanzoai/Zen-Dub/assets/163980830/57ef9dee-a9fd-4dc8-839b-3fbbbf0ff3f4 controls preload></video>
    </td>
    <td >
      <video src=https://github.com/hanzoai/Zen-Dub/assets/163980830/94d8dcba-1bcd-4b54-9d1d-8b6fc53228f0 controls preload></video>
    </td>
  </tr>
  <tr>
    <td>
    ...
    <td >
      <video src=https://github.com/hanzoai/Zen-Dub/assets/163980830/5fbab81b-d3f2-4c75-abb5-14c76e51769e controls preload></video>
    </td>
    <td >
      <video src=https://github.com/hanzoai/Zen-Dub/assets/163980830/f8100f4a-3df8-4151-8de2-291b09269f66 controls preload></video>
    </td>
  </tr>
   <tr>
    <td>
    ...
    <td >
      <video src=https://github.com/hanzoai/Zen-Dub/assets/163980830/a6e7d431-5643-4745-9868-8b423a454153 controls preload></video>
    </td>
    <td >
      <video src=https://github.com/hanzoai/Zen-Dub/assets/163980830/6ccf7bc7-cb48-42de-85bd-076d5ee8a623 controls preload></video>
    </td>
  </tr>
  <tr>
    <td>
    ...
    <td >
      <video src=https://github.com/hanzoai/Zen-Dub/assets/163980830/1568f604-a34f-4526-a13a-7d282aa2e773 controls preload></video>
    </td>
    <td >
      <video src=https://github.com/hanzoai/Zen-Dub/assets/163980830/a40784fc-a885-4c1f-9b7e-8f87b7caf4e0 controls preload></video>
    </td>
  </tr>
  <tr>
    <td>
    ...
    <td >
      <video src=https://github.com/hanzoai/Zen-Dub/assets/163980830/37a3a666-7b90-4244-8d3a-058cb0e44107 controls preload></video>
    </td>
    <td >
      <video src=https://github.com/hanzoai/Zen-Dub/assets/163980830/172f4ff1-d432-45bd-a5a7-a07dec33a26b controls preload></video>
    </td>
  </tr>
  <tr>
    <td>
    ...
    <td >
      <video src=https://github.com/hanzoai/Zen-Dub/assets/163980830/85a6873d-a028-4cce-af2b-6c59a1f2971d controls preload></video>
    </td>
  </tr>
</table >
...
```bib
@article{zen-dub,
  title={Zen-Dub: Real-Time High-Fidelity Video Dubbing via Spatio-Temporal Sampling},
...
```
# Disclaimer/License
1. `code`: The code of Zen-Dub is released under the MIT License. There is no limitation for both academic and commercial usage.
...
1. `demo assets`: The bundled sample images, audio, and video are provided for demonstration purposes; replace them with your own media for production use.
