...
mkdir %CheckpointsDir%\face-alignment
...
curl -L https://www.adrianbulat.com/downloads/python-fan/2DFAN4-cd938726ad.zip -o %CheckpointsDir%\face-alignment\2DFAN4-cd938726ad.pth
